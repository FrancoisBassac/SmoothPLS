---
title: "smoothPLS_multi_states_05"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{smoothPLS_multi_states_05}
...
```{r}
df_processed = cat_data_to_indicatrice(df_cfd)
...
```{r}
df_test_processed = cat_data_to_indicatrice(df_test)
...
# Naive
df_test_wide = naivePLS_formating(df_list = df_test,
                                  regul_time_obj = regul_time,
                                  curve_type_obj = curve_type, 
                                  id_col_obj = 'id', time_col_obj = 'time')
